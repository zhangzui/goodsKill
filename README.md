...
3.可通过http://localhost:18080/goodsKill/swagger-ui.html#/访问swagger主页

4.使用IDEA工具启动SampleJettyJspApplication main方法时可能会出现无法找到返回的jsp页面的情况，解决办法是设置SampleJettyJspApplication的working directory目录为goodsKill-server,IDEA默认以goodsKill作为working directory，elicpse不需要设置可以直接启动。
